...
class game {
    public static void main(String[] args) {
        ...
        //Banner and Rules of the JavaProjects.game
        System.out.println();
        System.out.println("<=============== Welcome to Loniantech Word Guessing JavaProjects.game ===============>");
        System.out.println();

        System.out.println("These are the rules for the JavaProjects.game");
        System.out.println();
               ...
               if (z.equalsIgnoreCase(userchose)){
                   switch (z) {
                       ...
                       case "Games" -> {
                           ...
                           Hint1 = "It is popular mobile JavaProjects.game in the Philippines.";
                           Hint2 = "It can be both play by first person POV \n and it can be third person POV and Developed by Garena and adapted from pc video JavaProjects.game Call of Duty";
                       }
                       case "Animals" -> {
                           Word = "Lion";
            ...
            for(int i = 0; true; i++){
                ...
                if (guess.equalsIgnoreCase(Word)){
                   ...
                   break;
                    ...
                    System.out.println();
                   //if the player runs out guesses display JavaProjects.game over
                    System.out.println();
